...
public class GhostScript : MonoBehaviour
{
    ...
    private void MOVE ()
    {
        ...
        if(Anim.GetCurrentAnimatorStateInfo(0).fullPathHash == MoveState)
        {
            ...
            MOVE_Velocity(new Vector3(Speed * horizontal, 0, Speed * vertical));
        }
        KEY_DOWN();
        KEY_UP();
    }
    ...
    // value for moving
    //---------------------------------------------------------------------
    private void MOVE_Velocity (Vector3 velocity)
    {
        ...
        this.transform.rotation = Quaternion.RotateTowards(transform.rotation, targetRotation, 999999);
        }
    //---------------------------------------------------------------------
